---
title: 'Spark之九:Spark数据倾斜调优'
date: 2021-01-08 15:23:08
tags: [spark, bigdata]
categories: Spark
description: 有的时候，我们可能会遇到大数据计算中一个最棘手的问题——数据倾斜，此时Spark作业的性能会比期望差很多。数据倾斜调优，就是使用各种技术方案解决不同类型的数据倾斜问题，以保证Spark作业的性能。
---
...
![](shuffle-skwed-add-partition.png)
...
![](shuffle-skwed-two-phase-aggr.png)
...
![](shuffle-skwed-sample-expand.png)
